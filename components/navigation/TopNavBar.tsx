...
export default function TopNavBar({ icons = [] }: TopNavBarProps) {
  ...
  const noBackButtonRoutes = ["/menu", "/order", "/profile"]; // Rutas donde no se muestra el botón de retroceso
  ...
  return (
    ...
    >
      {!noBackButtonRoutes.includes(pathname) ? (
        <TouchableOpacity
      ...
      <View style={styles.iconsContainer}>
        {icons.map((icon, menu) => (
          <Link key={menu} href={icon.link as any} asChild>
